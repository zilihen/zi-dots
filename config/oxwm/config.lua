...
oxwm.key.bind({ modkey }, "Up", oxwm.inc_num_master(1))
oxwm.key.bind({ modkey }, "Down", oxwm.inc_num_master(-1))
...
oxwm.key.bind({ modkey, "Control" }, "Comma", oxwm.monitor.tag(-1))
oxwm.key.bind({ modkey, "Control" }, "Period", oxwm.monitor.tag(1))
...
oxwm.key.bind({ modkey, "Control" }, "1", oxwm.tag.move_to(0))
oxwm.key.bind({ modkey, "Control" }, "2", oxwm.tag.move_to(1))
oxwm.key.bind({ modkey, "Control" }, "3", oxwm.tag.move_to(2))
oxwm.key.bind({ modkey, "Control" }, "4", oxwm.tag.move_to(3))
oxwm.key.bind({ modkey, "Control" }, "5", oxwm.tag.move_to(4))
oxwm.key.bind({ modkey, "Control" }, "6", oxwm.tag.move_to(5))
oxwm.key.bind({ modkey, "Control" }, "7", oxwm.tag.move_to(6))
